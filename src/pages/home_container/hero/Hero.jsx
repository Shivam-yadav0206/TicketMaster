...
import Friends from "../../../assets/friends2.png";
    ...
    <div className="w-full h-[calc(100vh-8ch)] lg:ps-28 md:ps-16 sm:ps-7 ps-4 mt-[8ch] flex items-center justify-center flex-col hero relative">
      <div className="flex-1 w-full flex items-stretch justify-between gap-12 pb-10">
        <motion.dev
          ...
          transition={{ duration: 0.5, ease: "linear", deley: 0.2 }}>
          <motion.dev
            className="space-y-5"
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <motion.h1 className="lg:text-7xl md:text-4xl font-bold text-neutral-50 leading-[1.15]">
              Reserve Your Outing{" "}
              <span className="text-violet-400 tracking-wider ">Plans</span>{" "}
              Now!
            </motion.h1>
            <motion.p
